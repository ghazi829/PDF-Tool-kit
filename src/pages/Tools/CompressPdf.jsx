...
import { Upload, Zap, CheckCircle2, ArrowRight, Shield, Lock, ArrowLeft, FileText } from 'lucide-react';
...
const CompressPdf = () => {
  ...
  const handleDownload = () => {
    ...
    doc.setFontSize(14);
    doc.text('Compression Results:', 20, 50);
    ...
    const compressedSize = (file.size / 1024 * 0.4).toFixed(2); // Simulate 60% reduction
    ...
    doc.text([
      ...
      `Total Savings: 60%`,
      "",
      "Our ninja compression algorithm optimizes images and fonts without losing perceptible quality.",
      "",
      "This is a demonstration of the PDFNinja compression workflow."
    ], 20, 70);
    
    doc.save("compressed_document.pdf");
  };
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative">
          ...
          <h1 className="text-5xl md:text-7xl font-display font-extrabold text-navy mb-6 tracking-tight">
            Compress <span className="text-primary italic">PDF</span> Files <br /> 
            in a Flash.
          </h1>
          <p className="text-xl text-navy/60 max-w-2xl mx-auto mb-12">
            Shrink your PDF file size while maintaining the highest possible quality for sharing.
          </p>
              ...
              <div className="transition-opacity duration-300">
                ...
                {(status === 'uploading' || status === 'converting') && (
                  <div className="py-12 flex flex-col items-center animate-in fade-in duration-300">
                    ...
                    <h3 className="text-2xl font-bold text-navy mb-2">
                      {status === 'uploading' ? 'Analyzing file size...' : 'Optimizing assets...'}
                    </h3>
                    <p className="text-navy/40">Shrinking your file with ninja speed...</p>
                  </div>
                )}
                ...
                {status === 'success' && (
                  <div className="py-8 flex flex-col items-center text-center animate-in zoom-in-95 duration-500">
                    ...
                    <h3 className="text-3xl font-bold text-navy mb-2">Compression Done!</h3>
                    <p className="text-navy/60 mb-8">Your PDF has been successfully optimized and is ready for download.</p>
