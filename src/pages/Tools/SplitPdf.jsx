...
import { Upload, Scissors, CheckCircle2, ArrowRight, Shield, Zap, Lock, ArrowLeft, FileText } from 'lucide-react';
...
const SplitPdf = () => {
  ...
  const handleDownload = () => {
    ...
    doc.setFontSize(14);
    doc.text('Split PDF Results:', 20, 50);
    ...
    doc.text([
      ...
      "Action: Successfully split into individual pages.",
      "",
      "In a real application, you would be prompted to select specific pages or ranges to extract.",
      "The individual pages would then be zipped or downloaded as separate PDF files.",
      "",
      "This is a demonstration of the PDFNinja workflow."
    ], 20, 70);
    
    doc.save("split_pages.pdf");
  };
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative">
          ...
          <h1 className="text-5xl md:text-7xl font-display font-extrabold text-navy mb-6 tracking-tight">
            Split <span className="text-primary italic">PDF</span> Pages <br /> 
            with Precision.
          </h1>
          <p className="text-xl text-navy/60 max-w-2xl mx-auto mb-12">
            Extract specific pages or split your PDF into individual files instantly.
          </p>
              ...
              <div className="transition-opacity duration-300">
                  ...
                  <div className="py-12 flex flex-col items-center animate-in fade-in duration-300">
                    <div className="relative w-24 h-24 mb-8">
                       ...
                       <div className="absolute inset-0 flex items-center justify-center font-display font-bold text-navy text-lg">
                          {status === 'uploading' ? `${uploadProgress}%` : <Scissors className="text-primary animate-pulse" />}
                       </div>
                    </div>
                    <h3 className="text-2xl font-bold text-navy mb-2">
                      {status === 'uploading' ? 'Analyzing pages...' : 'Extracting documents...'}
                    </h3>
                    <p className="text-navy/40">Slicing through your PDF...</p>
                  </div>
                )}
                ...
                {status === 'success' && (
                  <div className="py-8 flex flex-col items-center text-center animate-in zoom-in-95 duration-500">
                    ...
                    <h3 className="text-3xl font-bold text-navy mb-2">Split Complete!</h3>
                    <p className="text-navy/60 mb-8">Your PDF has been successfully split into separate documents.</p>
